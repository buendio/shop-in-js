var gulp = require('gulp'),// Подключаем gulp
    ...
    gulp.task('watch', ['browser-sync', 'less', 'scripts', 'style'], function() {
    gulp.watch('app/less/style.less', ['less']); // Наблюдение за less файлами
...
gulp.task('img', function() {
    ...
    gulp.task('build', ['clean', 'img', 'less', 'scripts', 'style'], function() {
